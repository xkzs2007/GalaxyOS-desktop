...
import sys as _sys2
_CORE_PATH = os.path.join(WORKSPACE, "skills", "galaxyos-engine", "skills", "llm-memory-integration", "core")
        ...
        try:
            ...
            try:
                ...
                _candidate_paths = [
                    ...
                    Path(workspace()) / "skills" / "galaxyos-engine" / "config" / "llm_config.json",
                ]
                _loaded_emb = None
