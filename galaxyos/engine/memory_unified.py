...
完整功能见 skills/xiaoyi-claw-omega-final/skills/llm-memory-integration/core/xiaoyi_claw_api.py
"""
...
class UnifiedMemory:
    ...
    def _get_claw(self):
        ...
        if self._claw is None:
            canonical = Path.home() / ".openclaw/workspace/skills/xiaoyi-claw-omega-final/skills/llm-memory-integration/core"
