...
优先读取环境变量，fallback �?expanduser 默认值�?

环境变量:
  OPENCLAW_HOME    - 根目�?(默认 ~/.openclaw)
...
def find_native_lib(lib_name: str) -> str:
    """�?native_lib_dirs() 中查找原生共享库，返回首个匹配路径或空字符串"""
