...
PERSONA_FILE = path_resolver.MEMORY_TDAI_DIR / "persona.md"
MEMORY_FILE = path_resolver.WORKSPACE_ROOT / "MEMORY.md"
VECTORS_DB = path_resolver.VECTORS_DB
CONFIG_FILE = CONFIG_DIR / "persona_update.json"
LOG_FILE = path_resolver.MEMORY_TDAI_DIR / ".metadata" / "persona_update.log"
