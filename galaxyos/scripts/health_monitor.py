...
MEMORY_TDai = path_resolver.MEMORY_TDAI_DIR
VECTORS_DB = MEMORY_TDai / "vectors.db"
TFIDF_DB = path_resolver.OPENCLAW_HOME / "tfidf-storage" / "tfidf.db"
QDRANT_STORAGE = path_resolver.OPENCLAW_HOME / "qdrant-storage"
