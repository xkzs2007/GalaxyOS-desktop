...
VEC_EXT = path_resolver.SQLITE_VEC_TENCENTDB
CONFIG_FILE = path_resolver.OPENCLAW_HOME / "memory-tencentdb.json"
...
def check_scripts():
    ...
    scripts_dir = path_resolver.SKILLS_DIR / "llm-memory-integration" / "scripts"
