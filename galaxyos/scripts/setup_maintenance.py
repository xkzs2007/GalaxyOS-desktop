...
VECTORS_DB = path_resolver.VECTORS_DB
from paths import VEC_EXT
LOG_FILE = path_resolver.MEMORY_TDAI_DIR / ".metadata" / "maintenance.log"
...
# 每周一 03:00 运行完整维护
0 3 * * 1 python3 {path_resolver.LLM_MEMORY_SCRIPTS}/run_maintenance.py

# 每日 06:00 检查覆盖率
0 6 * * * python3 {path_resolver.LLM_MEMORY_SCRIPTS}/check_coverage.py
...
```bash
# 完整维护
python3 {path_resolver.LLM_MEMORY_SCRIPTS}/run_maintenance.py

# 检查覆盖率
python3 {path_resolver.LLM_MEMORY_SCRIPTS}/check_coverage.py

# 重建 FTS
python3 {path_resolver.LLM_MEMORY_SCRIPTS}/rebuild_fts.py
```
...
- 维护日志: `{path_resolver.MEMORY_TDAI_DIR}/.metadata/maintenance.log`
- 推送记录: `{path_resolver.TODAY_TASK_DIR}/push_records/`
