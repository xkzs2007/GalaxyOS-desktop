  ...
  return (
    <div className="tokui-rccam-control" style={{ padding: '12px', background: '#fafafa', borderRadius: '8px', border: '1px solid #e0e0e0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
        <span style={{ fontWeight: 600, fontSize: '14px' }}>R-CCAM 控制</span>
      ...
      <div style={{ marginBottom: '8px' }}>
        <div style={{ fontSize: '11px', color: '#888', marginBottom: '2px' }}>检索深度: {retrievalDepth}</div>
        <input
          type="range"
          min={1}
          max={5}
      ...
      <div>
        <div style={{ fontSize: '11px', color: '#888', marginBottom: '2px' }}>认知策略</div>
        <select
