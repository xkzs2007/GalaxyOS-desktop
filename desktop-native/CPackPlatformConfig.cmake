...
elseif(CPACK_GENERATOR STREQUAL "ZIP")
    ...
    set(CPACK_PACKAGE_FILE_NAME "GalaxyOS-${CPACK_PACKAGE_VERSION}-windows-x64-portable")
...
elseif(CPACK_GENERATOR STREQUAL "TGZ")
    ...
    set(CPACK_PACKAGE_FILE_NAME "GalaxyOS-${CPACK_PACKAGE_VERSION}-linux-x64-portable")
endif()
