...
| **文档版本**: v4.5 | 2026-05-20 21:40 | Galaxy 增强（DAG三维绑定/Cognition Forest/KoRa/Kernel） |

---

*小艺 Claw — OpenClaw 的核心底层能力引擎*
*文档版本: v4.5 | 最后更新: 2026-05-20 21:40*
...
### v4.4 (2026-05-20 18:06) — 人格视觉 + Merge Gate + Rails增强版 + 用户画像驱动内在元认知进化（上一版）
