# [废弃] 小艺 Claw 系统架构 v3.1.1

> ⚠️ **此文档已废弃，仅供历史参考**
> **最新文档**: `xiaoyi-claw-core-architecture-v3.4.0.md`（v3.4.1）
> **废弃原因**: v3.4.1 新增论文方向四扩展（多Agent批评者+LLM自评分+重放缓冲区+隐式偏好）+ KV缓存全线修复 + Worker常驻批评者
...
│  │  │  查询改写、结果总结、语义过滤                                    │   │
│  │  │  ├─ Beta 端点: https://api.deepseek.com/beta                     │   │
│  │  │  ├─ prefix: True（查询改写 + 结果总结）                          │   │
│  │  │  ├─ thinking: disabled（简单任务关闭推理，节省token）            │   │
│  │  │  └─ temperature 生效（非思考模式）                               │   │
│  │  │                                                                  │   │
│  │  └─ 集成点:                                                          │   │
