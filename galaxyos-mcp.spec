a = Analysis(
    ...
    hiddenimports=[
        ...
        'openjiuwen_studio',
        'openjiuwen_studio.main',
        'openjiuwen_studio.core',
        'openjiuwen_studio.routers',
        'openjiuwen_studio.models',
        'openjiuwen_studio.ops',
        'openjiuwen_studio.conf',
        'openjiuwen_studio.lowcode',
        'openjiuwen_studio.evaluation',
        'openjiuwen_studio.marketplace',
        'openjiuwen_studio.memory_engine_start',
        'openjiuwen_studio.core.database',
        'openjiuwen_studio.core.config',
        'openjiuwen_studio.core.scheduler',
        'openjiuwen_studio.core.alembic_version_check',
        'openjiuwen_studio.core.manager',
        'openjiuwen_studio.core.dsl_converter',
        'openjiuwen_studio.ops.config',
        'openjiuwen_studio.ops.modules',
        'openjiuwen_studio.ops.modules.prompt',
        'openjiuwen_studio.ops.modules.prompt.infra',
        'openjiuwen_studio.ops.modules.prompt.infra.database',
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
